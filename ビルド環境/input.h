...
#define BUTTON_RUP		0x00010000l	// 右スティック上	(.lRy < 0)
#define BUTTON_RDOWN	0x00020000l	// 右スティック下	(.lRy > 0)
#define BUTTON_RLEFT	0x00040000l	// 右スティック左	(.lRx < 0)
#define BUTTON_RRIGHT	0x00080000l	// 右スティック右	(.lRy > 0
...
#define BUTTON_BACK		0x00002000l	// BACKボタン
#define BUTTON_LPRESS	0x00003000l	// 左スティック押し込み(.rgbButtons[10]&0x80)
#define BUTTON_RPRESS	0x00004000l	// 右スティック押し込み(.rgbButtons[10]&0x80)
