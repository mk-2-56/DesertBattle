...
{
	{ (char*)"data/BGM/bgm_title.wav", -1 },	// タイトル画面
	{ (char*)"data/BGM/bgm_game.wav", -1 },		// ゲーム画面
	{ (char*)"data/BGM/bgm_tutorial.wav", -1 },	// チュートリアル画面
	{ (char*)"data/se/se_gameover.wav", 0 },	// ゲームオーバー
	{ (char*)"data/SE/se_gameClear.wav", 0 },	// ゲームクリア音
	{ (char*)"data/SE/se_slash01.wav", 0 },		// 斬撃音
	{ (char*)"data/SE/se_earthquake.wav", 0 },	// フィールドチェンジ
	{ (char*)"data/SE/se_click.wav", 0 },		// クリック音
	{ (char*)"data/SE/se_cursor.wav", 0 },		// モード選択
};
...
//=============================================================================
// ピッチ設定(全て)		2倍までしかできない、もっと速くしたいときはinitで設定を変える、ただしそのぶん倍速でデータ読み込むから負担
//=============================================================================
